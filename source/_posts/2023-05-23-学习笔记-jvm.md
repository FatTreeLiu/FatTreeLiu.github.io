...
## JVM堆内存为什么要分成新生代，老年代，持久代？新生代中为什么要分为Eden和Survivor？（复习）
...
## 简述一下垃圾回收器？说下各自的优缺点？有了解过cms和G1么？能详细说明一下么？（复习）
...
![G1堆](./2023-05-23-学习笔记-jvm/G1堆.png)
...
## JVM 是怎么从新生代到老年代？一个完整的GC流程是怎样的？（复习）
...
## 简述一下类加载过程，重点说明一下双亲委派模型，怎么破坏双亲委派模型？（复习）
...
![loadClass](./2023-05-23-学习笔记-jvm/loadClass.png)
...
## Java的四种引用有了解么？引用队列怎么使用？作用是什么？（复习）
...
## 怎么打出一个线程的堆栈信息？如果内存过高怎么分析？如果cpu过高怎么定位？（复习）
